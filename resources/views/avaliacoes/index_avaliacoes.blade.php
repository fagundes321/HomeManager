                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        <span class="text-muted small">
                                            @if (isset($produto->menor_preco) && $produto->maior_preco && $produto->menor_preco > $produto->maior_preco)
                                               R$ {{ number_format($produto->maior_preco, 2, ',', '.') }} - {{ number_format($produto->menor_preco, 2, ',', '.') }}
                                            @elseif(isset($produto->menor_preco) && $produto->maior_preco && $produto->menor_preco < $produto->maior_preco)
                                               R$ {{ number_format($produto->menor_preco, 2, ',', '.') }} - {{ number_format($produto->maior_preco, 2, ',', '.') }}
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            {{-- Excluir --}}
                                            <form action="{{ route('avaliacoes.destroy', $produto->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
