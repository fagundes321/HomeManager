<x-layout title="Editar Perecível - HomeManager">
            ...
            <div class="col-lg-9 col-xl-8">
                ...
                <div class="card shadow-sm border border-dark">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('pereciveis.update', $pereciveis->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-5">
                                    ...
                                    <input required autofocus type="text" id="nome" name="nome"
                                        ...
                                        value="{{ old('nome', $pereciveis->nome) }}">
                                </div>
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <input type="text" id="marca" name="marca" class="form-control border-dark"
                                        ...
                                        value="{{ old('marca', $pereciveis->marca) }}">
                                </div>
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <input required type="number" step="0" min="0" id="quantidade"
                                        ...
                                        value="{{ old('quantidade', $pereciveis->quantidade) }}">
                                </div>
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <input type="date" id="validade" name="validade"
                                        ...
                                        value="{{ old('validade', optional($pereciveis->validade)->format('Y-m-d')) }}">
                                </div>
                                ...
                                <div class="col-12 col-md-5">
                                    ...
                                    <select id="local" name="local" class="form-select border-dark" required>
                                        <option value="" disabled selected @selected(old('local', $pereciveis->local) === null)>
                                            Selecione o local
                                        </option>
                                        <option value="pereciveis" @selected(old('local', $pereciveis->local) === 'Despensa')>
                                            Despensa
                                        </option>
